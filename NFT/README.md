...
2. Within `static`, create a file called `index.html`, with the following contents.  Replace `YOUR_CONTRACT_ADDRESS` with the contract address that was printed out when you deployed the Faucet contract.  Replace `[Contents of NFTContract_sol_GameItem.abi]` with the contents of the file `NFTContract_sol_GameItem.abi`.
          ...
          <body>
            ...
            <script>  
                ...
                const NFTContractABI =  
                        [Contents of NFTContract_sol_GameItem.abi]
                      ;
                let NFTContract;
                let signer;
