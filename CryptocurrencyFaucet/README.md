...
2. Within `static`, create a file called `index.html`, with the following contents.  Replace `YOUR_CONTRACT_ADDRESS` with the contract address that was printed out when you deployed the Faucet contract. Replace `[Contents of faucetContract_sol_Token.abi]` with the contents of the file `faucetContract_sol_Token.abi`. You can of course edit the HTML file to change the symbol DecBUX to the symbol for your cryptocurrency.
          ...
          <body>
            ...
            <script>  
                ...
                const MintContractABI =  
                       [Contents of faucetContract_sol_Token.abi]
                      ;
                let MintContract;
                let signer;
